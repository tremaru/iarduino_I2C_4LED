// ПРИМЕР ВЫВОДА ДАННЫХ С РАЗНЫМИ ПАРАМЕТРАМИ:            // * Строки со звёздочкой являются необязательными.
                                                          //
...
int b=3000;                                               //   Объявляем переменную с указанием задержки после вывода.
                                                          //
void setup(){                                             //
...
void loop(){                                              //
     ...
     dispLED.light(    6                  );              //   Установка яркости 6.
                                                          //
     dispLED.turn (    1                  );    delay(b); //   Переворот изображения на 180°.
     dispLED.turn (    0                  );    delay(b); //   Возврат изображения к углу 0°.
                                                          //
     dispLED.print(    1                  );    delay(b); //   Вывод целого числа    1.
     ...
     dispLED.print( 6789   , LEN1, RIGHT  );    delay(b); //   Вывод целого числа 6789 в 1 разряде  (срезаются 3 первых разряда).
                                                          //
     dispLED.print("88.:8.8."             );    delay(b); //   Включение всех сегментов кроме точки в 1 позиции.
                                                          //
     dispLED.blink(    1, 1               );    delay(b); //   Включение  мигания знака в 1 позиции.
     dispLED.blink(    2, 1               );    delay(b); //   Включение  мигания знака в 2 позиции.
     dispLED.blink(    3, 1               );    delay(b); //   Включение  мигания знака в 3 позиции.
     dispLED.blink(    4, 1               );    delay(b); //   Включение  мигания знака в 4 позиции.
     dispLED.blink(    1, 0               );    delay(b); //   Отключение мигания знака в 1 позиции.
     dispLED.blink(    2, 0               );    delay(b); //   Отключение мигания знака в 2 позиции.
     dispLED.blink(    3, 0               );    delay(b); //   Отключение мигания знака в 3 позиции.
     dispLED.blink(    4, 0               );    delay(b); //   Отключение мигания знака в 4 позиции.
     dispLED.blink(    0, 1               );    delay(b); //   Включение  мигания двоеточия.
     dispLED.blink(    0, 0               );    delay(b); //   Отключение мигания двоеточия.
     dispLED.blink(    5, 1               );    delay(b); //   Включение  мигания всех светящихся сегментов дисплея.
     dispLED.blink(    5, 0               );    delay(b); //   Отключение мигания всех светящихся сегментов дисплея.
                                                          //
     dispLED.blink(    5, 1               );              //   Включение  мигания всех светящихся сегментов дисплея.
     dispLED.frequ(    4                  );              //   Устанавливаем частоту миганий в 4 Гц.
     dispLED.print( 4444                  );    delay(b); // * Вывод целого  числа 4444.
     dispLED.frequ(    3                  );              //   Устанавливаем частоту миганий в 3 Гц.
     dispLED.print( 3333                  );    delay(b); // * Вывод целого  числа 3333.
     dispLED.frequ(    2                  );              //   Устанавливаем частоту миганий в 2 Гц.
     dispLED.print( 2222                  );    delay(b); // * Вывод целого  числа 2222.
     dispLED.frequ(    1                  );              //   Устанавливаем частоту миганий в 1 Гц.
     dispLED.print( 1111                  );    delay(b); // * Вывод целого  числа 1111.
     dispLED.blink(    5, 0               );              //   Отключение мигания всех светящихся сегментов дисплея.
                                                          //
